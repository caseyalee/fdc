<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('admin')
            <x-responsive-nav-link :href="route('admin-emails')" :active="request()->routeIs('admin*')">
                Manage Emails
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin-members')" :active="request()->routeIs('admin*')">
                View Members
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin-changelog')" :active="request()->routeIs('admin*')">
                Changelog
            </x-responsive-nav-link>
            @endrole
        </div>
