...
@php
    $classes = ($active ?? false)
                ? 'parent-nav inline-flex items-center px-1 pt-1 border-b-2 border-c-purple text-sm font-semibold leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out cursor-pointer relative'
