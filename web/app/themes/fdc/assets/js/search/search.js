            ...
            <div class="brand-card-inner">
              <div class="front flex flex-wrap">
                <div class="top self-start w-full px-3 py-5 lg:px-5">
                  <p class="text-center font-semibold text-sm lg:text-base xl:text-lg text-gray-600 leading-tight hit-title">{{#helpers.highlight}}{ "attribute": "title" }{{/helpers.highlight}}</p>
                </div>
              ...
              <div class="back flex flex-wrap">
                <div class="top self-start w-full px-3 py-5 lg:px-5">
                  <p class="font-semibold text-sm lg:text-base xl:text-lg text-gray-600 leading-tight hit-title">{{#helpers.highlight}}{ "attribute": "title" }{{/helpers.highlight}}</p>
                </div>
