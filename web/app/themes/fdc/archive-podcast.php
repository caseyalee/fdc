                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('prose max-w-7xl prose-lg'); ?>>
                        ...
                        <div class="entry-content text-base">
                            ...
                            <div class="float-right mt-8">
                                <?php
                                    $more_link_text = (get_post_type() == 'podcast') ? 'Listen' : 'Continue Reading';
                                    $more_link_icon = (get_post_type() == 'podcast') ? 'fad fa-microphone' : 'fad fa-bookmark';
                                ?>
                                <a class="button button-sm" href="<?php echo get_permalink(); ?>"><i class="<?php echo $more_link_icon; ?>"></i> <?php echo $more_link_text; ?></a>
                            </div>
                        </div><!-- .entry-content -->
                        <hr>
